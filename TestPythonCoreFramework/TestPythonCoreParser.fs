...
// Statement unittests ////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    let ``typeargslist 14 test`` () =
            let lex = new MockTokenizer( [  ( Token.Name(0, 5, "Test1", [| |]), 0 ); ( Token.Colon(6, 7, [| |]), 6 ); ( Token.Name(8, 9, "c", [| |]), 8 ); ( Token.Assign(10, 11, [| |]), 10 ); ( Token.Name(12, 13, "b", [| |]), 12 ); 
                                            ...
                                            ( Token.Comma(79, 80, [| |]), 79 ); ( Token.Name(81, 82, "a", [| |]), 81 ); ( Token.Colon(83, 84, [| |]), 83 ); ( Token.Name(85, 86, "b", [| |]), 85 ); 
                                            ( Token.Comma(87, 88, [| |]), 87 ); ( Token.Power(89, 91, [| |]), 89 ); ( Token.Name(91, 92, "c", [| |]), 91 );
                                            ( Token.Comma(93, 94, [| |]), 93 )
                                            ( Token.RightParen(95, 96, [| |]), 95 ); ( Token.EOF([| |]), 97 ) ] )
            lex.Next()
            let parser = new Parser(lex)
            Assert.Equal( ASTNode.TypedArgsList(0, 95, [|   ASTNode.TypedAssign(0, 14,
                                                                                    ASTNode.TFPDef(0, 10,
                                                                                        ASTNode.Name(0, 6, Token.Name(0, 5, "Test1", [| |])),
                                                                                        Token.Colon(6, 7, [| |]),
                                                                                        ASTNode.Name(8, 10, Token.Name(8, 9, "c", [| |]))),
    ...
    let ``typeargslist 15 test`` () =
            let lex = new MockTokenizer( [  ( Token.Name(0, 5, "Test1", [| |]), 0 ); ( Token.Colon(6, 7, [| |]), 6 ); ( Token.Name(8, 9, "c", [| |]), 8 ); ( Token.Assign(10, 11, [| |]), 10 ); ( Token.Name(12, 13, "b", [| |]), 12 ); 
                                            ...
                                            ( Token.Comma(79, 80, [| |]), 79 ); ( Token.Name(81, 82, "a", [| |]), 81 ); ( Token.Colon(83, 84, [| |]), 83 ); ( Token.Name(85, 86, "b", [| |]), 85 ); 
                                            ( Token.Comma(87, 88, [| |]), 87 ); ( Token.Power(89, 91, [| |]), 89 ); ( Token.Name(91, 92, "c", [| |]), 91 );
                                            ( Token.Comma(93, 94, [| |]), 93 ); ( Token.TypeComment(95, 105, "#type: int"), 95);
                                            ( Token.RightParen(106, 107, [| |]), 106 ); ( Token.EOF([| |]), 108 ) ] )
            lex.Next()
            let parser = new Parser(lex)
            Assert.Equal( ASTNode.TypedArgsList(0, 106, [|   ASTNode.TypedAssign(0, 14,
                                                                                    ASTNode.TFPDef(0, 10,
                                                                                        ASTNode.Name(0, 6, Token.Name(0, 5, "Test1", [| |])),
                                                                                        Token.Colon(6, 7, [| |]),
                                                                                        ASTNode.Name(8, 10, Token.Name(8, 9, "c", [| |]))),
                                                        ...
                                                        [| 
                                                            ...
                                                            Token.TypeComment(31, 41, "#type: int");
                                                            Token.TypeComment(49, 59, "#type: int");
                                                            Token.TypeComment(95, 105, "#type: int")
                                                        |]), parser.ParseTypedArgsList())

    [<Fact>]
    let ``typeargslist 16 test`` () =
            let lex = new MockTokenizer( [  ( Token.Name(0, 5, "Test1", [| |]), 0 ); ( Token.Colon(6, 7, [| |]), 6 ); ( Token.Name(8, 9, "c", [| |]), 8 ); ( Token.Assign(10, 11, [| |]), 10 ); ( Token.Name(12, 13, "b", [| |]), 12 ); 
                                            ( Token.Comma(14, 15, [| |]), 14 ); ( Token.TypeComment(16, 26, "#type: int"), 16 ); ( Token.Name(27, 28, "d", [| |]), 27 );
                                            ( Token.Comma(29, 30, [| |]), 29 ); ( Token.TypeComment(31, 41, "#type: int"), 31 ); ( Token.Div(42, 43, [| |]), 42 );
                                            ( Token.Comma(43, 44, [| |]), 43 ); ( Token.Name(45, 46, "e", [| |]), 45 );
                                            ...
                                            ( Token.Comma(79, 80, [| |]), 79 ); ( Token.Name(81, 82, "a", [| |]), 81 ); ( Token.Colon(83, 84, [| |]), 83 ); ( Token.Name(85, 86, "b", [| |]), 85 ); 
                                            ( Token.Comma(87, 88, [| |]), 87 ); ( Token.Power(89, 91, [| |]), 89 ); ( Token.Name(91, 92, "c", [| |]), 91 );
                                            ( Token.TypeComment(95, 105, "#type: int"), 95);
                                            ( Token.RightParen(106, 107, [| |]), 106 ); ( Token.EOF([| |]), 108 ) ] )
            lex.Next()
            let parser = new Parser(lex)
            Assert.Equal( ASTNode.TypedArgsList(0, 106, [|   ASTNode.TypedAssign(0, 14,
                                                            ...
                                                            ASTNode.TFPDef(81, 87,  
                                                                                ...
                                                                                Token.Colon(83, 84, [| |]),
                                                                                ASTNode.Name(85, 87, Token.Name(85, 86, "b", [| |])) );
                                                            ASTNode.TypedPower(89, 95, Token.Power(89, 91, [| |]), ASTNode.Name(91, 95, Token.Name(91, 92, "c", [| |])))
                                                        |], 
                                                        [| 
                                                            Token.Comma(14, 15, [| |]);
                                                            Token.Comma(29, 30, [| |]);
    ...
    [<Fact>]
    let ``typeargslist 18 test`` () =
            let lex = new MockTokenizer( [  ( Token.Power(0, 2, [| |]), 0 ); ( Token.Name(2, 3, "c", [| |]), 2 );
                                            ( Token.Comma(4, 5, [| |]), 4 ); ( Token.TypeComment(6, 16, "#type: int"), 6);
                                            ( Token.RightParen(17, 18, [| |]), 17 ); ( Token.EOF([| |]), 19 ) ] )
            lex.Next()
            let parser = new Parser(lex)
            Assert.Equal( ASTNode.TypedArgsList(0, 17, [|   
                                                            ASTNode.TypedPower(0, 4, Token.Power(0, 2, [| |]), ASTNode.Name(2, 4, Token.Name(2, 3, "c", [| |])))
                                                        |], 
                                                        [| 
                                                            Token.Comma(4, 5, [| |])
                                                        |], 
    ...
    [<Fact>]
    let ``typeargslist 20 test`` () =
            let lex = new MockTokenizer( [  ( Token.Power(0, 2, [| |]), 0 ); ( Token.Name(2, 3, "c", [| |]), 2 );
                                            ( Token.Comma(4, 5, [| |]), 4 ); 
                                            ( Token.RightParen(6, 7, [| |]), 6 ); ( Token.EOF([| |]), 8 ) ] )
            lex.Next()
            let parser = new Parser(lex)
            Assert.Equal( ASTNode.TypedArgsList(0, 6, [|   
                                                            ASTNode.TypedPower(0, 4, Token.Power(0, 2, [| |]), ASTNode.Name(2, 4, Token.Name(2, 3, "c", [| |])))
                                                        |], 
                                                        [| 
                                                            Token.Comma(4, 5, [| |])
    ...
    [<Fact>]
    let ``typeargslist 21 test`` () =
            let lex = new MockTokenizer( [  ( Token.Power(0, 2, [| |]), 0 ); ( Token.Name(2, 3, "c", [| |]), 2 );
                                            ( Token.EOF([| |]), 4 ) ] )
            lex.Next()
            let parser = new Parser(lex)
            Assert.Equal( ASTNode.TypedArgsList(0, 4, [|   
                                                            ASTNode.TypedPower(0, 4, Token.Power(0, 2, [| |]), ASTNode.Name(2, 4, Token.Name(2, 3, "c", [| |])))
                                                        |], 
                                                        [| 
                                                        |], 
    ...
    let ``typeargslist 22 test`` () =
            let lex = new MockTokenizer( [  ( Token.Mul(0, 1, [| |]), 0 ); ( Token.Name(2, 3, "a", [| |]), 2 ); ( Token.Colon(4, 5, [| |]), 4 ); ( Token.Name(6, 7, "b", [| |]), 6 );
                                            ...
                                            ( Token.Comma(27, 28, [| |]), 27 ); ( Token.Power(29, 31, [| |]), 29 ); ( Token.Name(31, 32, "c", [| |]), 31 );
                                            ( Token.TypeComment(33, 43, "#type: int"), 33);
                                            ( Token.RightParen(44, 45, [| |]), 44 ); ( Token.EOF([| |]), 46 ) ] )
            lex.Next()
            let parser = new Parser(lex)
            Assert.Equal( ASTNode.TypedArgsList(0, 44, [|   ASTNode.TypedMul(0, 8, 
                                                                                    Token.Mul(0, 1, [| |]),
                                                                                    ASTNode.TFPDef(2, 8,
                                                            ...
                                                            ASTNode.TFPDef(21, 27,  
                                                                                ASTNode.Name(21, 23, Token.Name(21, 22, "a", [| |])),
                                                                                Token.Colon(23, 24, [| |]),
                                                                                ASTNode.Name(25, 27, Token.Name(25, 26, "b", [| |])) );
                                                            ASTNode.TypedPower(29, 33, Token.Power(29, 31, [| |]), ASTNode.Name(31, 33, Token.Name(31, 32, "c", [| |])))
                                                        |], 
                                                        [| 
                                                            Token.Comma(8, 9, [| |]);
                                                            Token.Comma(27, 28, [| |])
                                                        ...
                                                        [| 
                                                            Token.TypeComment(10, 20, "#type: int")
                                                            Token.TypeComment(33, 43, "#type: int")
                                                        |]), parser.ParseTypedArgsList())

    [<Fact>]
    let ``typeargslist 23 test`` () =
            let lex = new MockTokenizer( [  ( Token.Mul(0, 1, [| |]), 0 ); ( Token.Name(2, 3, "a", [| |]), 2 ); ( Token.Colon(4, 5, [| |]), 4 ); ( Token.Name(6, 7, "b", [| |]), 6 );
                                            ( Token.Comma(8, 9, [| |]), 8 ); ( Token.TypeComment(10, 20, "#type: int"), 10); ( Token.Name(21, 22, "a", [| |]), 21 ); ( Token.Colon(23, 24, [| |]), 23 ); ( Token.Name(25, 26, "b", [| |]), 25 ); 
                                            ( Token.Comma(27, 28, [| |]), 27 ); ( Token.Power(29, 31, [| |]), 29 ); ( Token.Name(31, 32, "c", [| |]), 31 );
                                            ( Token.Comma(33, 34, [| |]), 33 ); ( Token.TypeComment(35, 45, "#type: int"), 35);
                                            ( Token.RightParen(46, 47, [| |]), 46 ); ( Token.EOF([| |]), 48 ) ] )
            lex.Next()
            let parser = new Parser(lex)
            Assert.Equal( ASTNode.TypedArgsList(0, 46, [|   ASTNode.TypedMul(0, 8, 
                                                                                    Token.Mul(0, 1, [| |]),
                                                                                    ASTNode.TFPDef(2, 8,
                                                                                        ASTNode.Name(2, 4, Token.Name(2, 3, "a", [| |])),
                                                                                        Token.Colon(4, 5, [| |]),
                                                        ...
                                                        [| 
                                                            Token.TypeComment(10, 20, "#type: int")
                                                            Token.TypeComment(35, 45, "#type: int")
                                                        |]), parser.ParseTypedArgsList())

    [<Fact>]
    let ``typeargslist 24 test`` () =
            let lex = new MockTokenizer( [  ( Token.Mul(0, 1, [| |]), 0 ); ( Token.Name(2, 3, "a", [| |]), 2 ); ( Token.Colon(4, 5, [| |]), 4 ); ( Token.Name(6, 7, "b", [| |]), 6 );
                                            ( Token.Comma(8, 9, [| |]), 8 ); ( Token.TypeComment(10, 20, "#type: int"), 10); ( Token.Name(21, 22, "a", [| |]), 21 ); ( Token.Colon(23, 24, [| |]), 23 ); ( Token.Name(25, 26, "b", [| |]), 25 ); 
                                            ( Token.Comma(27, 28, [| |]), 27 ); ( Token.Power(29, 31, [| |]), 29 ); ( Token.Name(31, 32, "c", [| |]), 31 );
                                            ( Token.RightParen(33, 34, [| |]), 33 ); ( Token.EOF([| |]), 35 ) ] )
            lex.Next()
            let parser = new Parser(lex)
            Assert.Equal( ASTNode.TypedArgsList(0, 33, [|   ASTNode.TypedMul(0, 8, 
                                                                                    Token.Mul(0, 1, [| |]),
                                                                                    ASTNode.TFPDef(2, 8,
                                                                                        ASTNode.Name(2, 4, Token.Name(2, 3, "a", [| |])),
                                                                                        Token.Colon(4, 5, [| |]),
    ...
    [<Fact>]
    let ``typeargslist 25 test`` () =
            let lex = new MockTokenizer( [  ( Token.Mul(0, 1, [| |]), 0 ); ( Token.Name(2, 3, "a", [| |]), 2 ); ( Token.Colon(4, 5, [| |]), 4 ); ( Token.Name(6, 7, "b", [| |]), 6 );
                                            ( Token.Comma(8, 9, [| |]), 8 ); ( Token.TypeComment(10, 20, "#type: int"), 10); ( Token.Name(21, 22, "a", [| |]), 21 ); ( Token.Colon(23, 24, [| |]), 23 ); ( Token.Name(25, 26, "b", [| |]), 25 ); 
                                            ( Token.Comma(27, 28, [| |]), 27 );
    ...
    [<Fact>]
    let ``typeargslist 27 test`` () =
            let lex = new MockTokenizer( [  ( Token.Mul(0, 1, [| |]), 0 ); ( Token.Name(2, 3, "a", [| |]), 2 ); ( Token.Colon(4, 5, [| |]), 4 ); ( Token.Name(6, 7, "b", [| |]), 6 );
                                            ( Token.Comma(8, 9, [| |]), 8 ); 
                                            ( Token.RightParen(10, 11, [| |]), 10 ); ( Token.EOF([| |]), 12 ) ] )
            lex.Next()
            let parser = new Parser(lex)
            Assert.Equal( ASTNode.TypedArgsList(0, 10, [|   ASTNode.TypedMul(0, 8, 
                                                                                    Token.Mul(0, 1, [| |]),
                                                                                    ASTNode.TFPDef(2, 8,
                                                                                        ASTNode.Name(2, 4, Token.Name(2, 3, "a", [| |])),
                                                                                        Token.Colon(4, 5, [| |]),
    ...
    [<Fact>]
    let ``typeargslist 28 test`` () =
            let lex = new MockTokenizer( [  ( Token.Mul(0, 1, [| |]), 0 ); ( Token.Name(2, 3, "a", [| |]), 2 ); ( Token.Colon(4, 5, [| |]), 4 ); ( Token.Name(6, 7, "b", [| |]), 6 );
                                            ( Token.EOF([| |]), 8 ) ] )
            lex.Next()
            let parser = new Parser(lex)
            Assert.Equal( ASTNode.TypedArgsList(0, 8, [|   ASTNode.TypedMul(0, 8, 
                                                                                    Token.Mul(0, 1, [| |]),
                                                                                    ASTNode.TFPDef(2, 8,
                                                                                        ASTNode.Name(2, 4, Token.Name(2, 3, "a", [| |])),
                                                                                        Token.Colon(4, 5, [| |]),
